...
const ImageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-box svelte-ezq2y0">${user?.username === image.author || user?.role !== UserRole.EDITOR ? `<div class="image-edit svelte-ezq2y0"><i class="fa-solid fa-ellipsis svelte-ezq2y0"></i>
...
//# sourceMappingURL=_page.svelte-2c0df786.js.map
