...
const css$a = {
  code: ".image-box.svelte-5jjxa6.svelte-5jjxa6{grid-column:1 / span 4;display:grid;grid-auto-rows:min-content;height:min-content;background-color:#ffffff;box-shadow:0 2px 10px #666666;container:imagebox / inline-size}.image-edit.svelte-5jjxa6.svelte-5jjxa6{display:flex;position:relative;justify-content:flex-end;align-items:center;height:30px;padding:0 10px;background-color:#444444}.image-edit.svelte-5jjxa6 i.svelte-5jjxa6{display:flex;align-items:center;justify-content:center;width:24px;height:16px;margin-left:auto;padding:0;border:none;color:#ffffff;cursor:pointer}.image-edit.svelte-5jjxa6 i.svelte-5jjxa6:hover{background-color:#666666}.image-author.svelte-5jjxa6.svelte-5jjxa6{display:grid;grid-template-columns:48px 1fr;grid-auto-rows:min-content;align-content:center;height:min-content;padding:6px;column-gap:10px}.image-author-link.svelte-5jjxa6.svelte-5jjxa6{grid-row:1 / span 2;width:48px;height:48px}.image-author.svelte-5jjxa6 img.svelte-5jjxa6{width:100%;height:100%;border-radius:50%;box-shadow:0 0 1px 1px #666666;object-fit:cover}.image-author-username.svelte-5jjxa6.svelte-5jjxa6{width:max-content;height:min-content;font-size:20px;font-weight:700}.image-content.svelte-5jjxa6.svelte-5jjxa6{max-width:768px;height:auto;margin:0 auto}.image-description.svelte-5jjxa6.svelte-5jjxa6{padding:20px;overflow-wrap:anywhere;text-align:center}.image-description.svelte-5jjxa6 form.svelte-5jjxa6{display:flex;flex-wrap:wrap;justify-content:center;gap:10px}.image-description.svelte-5jjxa6 textarea.svelte-5jjxa6{width:100%;height:fit-content;padding:10px;border:none;outline:none;border-bottom:2px solid #666666;overflow-wrap:anywhere;text-align:center;scrollbar-width:none}.image-description.svelte-5jjxa6 button.svelte-5jjxa6{width:100px;padding:8px 0;border:none;border-radius:6px;background-color:#d33535;font-weight:700;color:#ffffff;cursor:pointer}.image-description.svelte-5jjxa6 .blue.svelte-5jjxa6{background-color:#4d4adb}@media(max-width: 1040px){.image-box.svelte-5jjxa6.svelte-5jjxa6{grid-column:1 / span 6}}@container imagebox (max-width: 768px){.image-content.svelte-5jjxa6.svelte-5jjxa6{width:100%}}",
  map: null
};
const ImageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-box svelte-5jjxa6">${user && (user?.username === image.author || user?.role !== UserRole.EDITOR) ? `<div class="image-edit svelte-5jjxa6"><i class="fa-solid fa-ellipsis svelte-5jjxa6"></i>
			${slots.default ? slots.default({}) : ``}</div>` : ``}
	<h2 class="title"><i class="fa-solid fa-image title-icon"></i>
		${escape(image.title)}</h2>
	<div class="image-author svelte-5jjxa6"><a class="image-author-link svelte-5jjxa6" href="${"/user/" + escape(image.author, true)}"><img src="${escape(DIR, true) + "/uploads/avatars/" + escape(image.avatar, true)}"${add_attribute("alt", image.author, 0)} class="svelte-5jjxa6"></a>
		<a class="image-author-username svelte-5jjxa6" href="${"/user/" + escape(image.author, true)}">${escape(image.author)}</a>
		<p>${escape(image.views)} views ● ${escape(format(image.createdAt))}</p></div>
	<img class="image-content svelte-5jjxa6" src="${escape(DIR, true) + "/uploads/" + escape(image.filename, true)}"${add_attribute("alt", image.title, 0)}>
	<div class="image-description svelte-5jjxa6">${description ? `<form action="${escape(DIR, true) + "/api/image/" + escape(image.id, true) + "/description"}" method="POST" class="svelte-5jjxa6"><textarea id="edit" name="description" rows="1" spellcheck="false" autocomplete="off" maxlength="4200" class="svelte-5jjxa6">${image.description || ""}</textarea>
				<button class="svelte-5jjxa6">Cancel
				</button>
				<button class="blue svelte-5jjxa6">Send
...
function isImage(object) {
  return object.favorites !== void 0;
}
function isComment(object) {
  return object.comment !== void 0;
}
const css$1 = {
...
const ImageIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function checkElement() {
    if (isImage(object) && id === "fav")
      return object.favorites.includes(user?.username);
    else if (id === "like")
      return object.likes.includes(user?.username);
  ...
  function countElements() {
    if (isImage(object) && id === "fav")
      return object.favorites.length;
    else if (id === "like")
  ...
  return `<div class="svelte-xdj7pf"><i class="${"fa-solid " + escape(selectIcon(), true) + " " + escape(check ? name : "", true) + " svelte-xdj7pf"}"></i>
	${escape(count)}
</div>`;
});
const css = {
      ...
      },
      {
        assessment: () => {
          return `<div class="image-stats svelte-2mhczw" slot="assessment">${validate_component(ImageIcon, "ImageIcon").$$render(
            $$result,
            { user: data.user, object: data.image },
            {
              object: ($$value) => {
                data.image = $$value;
                $$settled = false;
...
//# sourceMappingURL=_page.svelte-8fdc67b8.js.map
