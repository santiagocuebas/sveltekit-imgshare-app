import { c as create_ssr_component, e as escape, d as add_attribute, f as null_to_empty } from './index2-1f46a731.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="foreignuser-header svelte-1k2k6n1"><div class="foreignuser-head svelte-1k2k6n1"><img src="${escape(DIR, true) + "/uploads/avatars/" + escape(data.foreignUser.avatar, true)}"${add_attribute("alt", data.foreignUser.username, 0)} class="svelte-1k2k6n1">
...
//# sourceMappingURL=_layout.svelte-21105726.js.map
