...
const css$a = {
  code: ".image-box.svelte-1lm9av0.svelte-1lm9av0{grid-column:1 / span 4;display:grid;grid-auto-rows:min-content;height:min-content;background-color:#ffffff;box-shadow:0 2px 10px #666666}.image-edit.svelte-1lm9av0.svelte-1lm9av0{display:flex;position:relative;justify-content:flex-end;align-items:center;height:30px;padding:0 10px;background-color:#444444}.image-edit.svelte-1lm9av0 i.svelte-1lm9av0{display:flex;align-items:center;justify-content:center;width:24px;height:16px;margin-left:auto;padding:0;border:none;color:#ffffff;cursor:pointer}.image-edit.svelte-1lm9av0 i.svelte-1lm9av0:hover{background-color:#666666}.image-author.svelte-1lm9av0.svelte-1lm9av0{display:grid;grid-template-columns:48px 1fr;grid-auto-rows:min-content;align-content:center;height:min-content;padding:6px;column-gap:10px}.image-author-link.svelte-1lm9av0.svelte-1lm9av0{grid-row:1 / span 2;width:48px;height:48px}.image-author-avatar.svelte-1lm9av0.svelte-1lm9av0{width:100%;height:100%;border-radius:50%;box-shadow:0 0 1px 1px #666666;object-fit:cover}.image-author-username.svelte-1lm9av0.svelte-1lm9av0{height:min-content;font-size:20px;font-weight:700}.image-content.svelte-1lm9av0.svelte-1lm9av0{width:100%;max-width:768px;height:auto;margin:0 auto}.image-description.svelte-1lm9av0.svelte-1lm9av0{padding:20px;overflow-wrap:anywhere;text-align:center}.image-form.svelte-1lm9av0.svelte-1lm9av0{display:flex;flex-wrap:wrap;justify-content:center;gap:10px}.image-form.svelte-1lm9av0 textarea.svelte-1lm9av0{width:100%;height:fit-content;padding:10px;border:none;outline:none;border-bottom:2px solid #666666;overflow-wrap:anywhere;text-align:center;scrollbar-width:none}.image-form.svelte-1lm9av0 button.svelte-1lm9av0{width:100px;padding:8px 0;border:none;border-radius:6px;background-color:#d33535;font-weight:700;color:#ffffff;cursor:pointer}.image-form.svelte-1lm9av0 .blue.svelte-1lm9av0{background-color:#4d4adb}@media(max-width: 1040px){.image-box.svelte-1lm9av0.svelte-1lm9av0{grid-column:1 / span 6}}",
  map: null
};
const ImageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-box svelte-1lm9av0">${user && (user.username === image.author || user.role !== UserRole.EDITOR) ? `<div class="image-edit svelte-1lm9av0"><i class="fa-solid fa-ellipsis svelte-1lm9av0"></i>
			${slots.default ? slots.default({}) : ``}</div>` : ``}
	<h2 class="title"><i class="fa-solid fa-image title-icon"></i>
		${escape(image.title)}</h2>
	<div class="image-author svelte-1lm9av0"><a class="image-author-link svelte-1lm9av0" href="${"/user/" + escape(image.author, true)}"><img class="image-author-avatar svelte-1lm9av0" src="${escape(DIR, true) + "/uploads/avatars/" + escape(image.avatar, true)}"${add_attribute("alt", image.author, 0)}></a>
		<a class="image-author-username svelte-1lm9av0" href="${"/user/" + escape(image.author, true)}">${escape(image.author)}</a>
		<p>${escape(image.views)} views ● ${escape(format(image.createdAt))}</p></div>
	<img class="image-content svelte-1lm9av0" src="${escape(DIR, true) + "/uploads/" + escape(image.filename, true)}"${add_attribute("alt", image.title, 0)}>
	<div class="image-description svelte-1lm9av0">${description ? `<form class="image-form svelte-1lm9av0" action="${escape(DIR, true) + "/api/image/" + escape(image.id, true) + "/description"}" method="POST"><textarea id="edit" name="description" rows="1" spellcheck="false" autocomplete="off" maxlength="4200" class="svelte-1lm9av0">${image.description || ""}</textarea>
				<button class="svelte-1lm9av0">Cancel
				</button>
				<button class="blue svelte-1lm9av0">Send
...
const css$6 = {
  code: ".comment-form.svelte-lc8ktd{width:100%;background-color:#ffffff;box-shadow:0 2px 10px #666666}form.svelte-lc8ktd{display:grid;grid-template-columns:40px 1fr;grid-auto-rows:min-content;padding:10px;gap:10px}img.svelte-lc8ktd{grid-row:1 / span 2;width:40px;height:40px;border-radius:50%;box-shadow:0 0 1px 1px #666666;object-fit:cover}input.svelte-lc8ktd{width:100%;height:min-content;padding:4px 0;border:none;outline:none;border-bottom:1px solid #888888}input.svelte-lc8ktd:focus{border-bottom:2px solid #333333}.comment-buttons.svelte-lc8ktd{display:flex;margin-left:auto;gap:10px}button.svelte-lc8ktd{width:100px;height:40px;border:none;background-color:#ffffff;font-weight:700;cursor:pointer}button.svelte-lc8ktd:hover{background-color:#dddddd}.blue.svelte-lc8ktd{background-color:#5383d3;color:#ffffff}.blue.svelte-lc8ktd:hover{background-color:#4373c3}.disabled.svelte-lc8ktd{background-color:#dddddd;color:#888888;cursor:auto}",
  map: null
};
const CommentForm = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="comment-form svelte-lc8ktd"><h2 class="title"><i class="fa-regular fa-copy title-icon"></i>
		Post
	</h2>
	<form action="${escape(DIR, true) + "/api/image/" + escape(imageId, true) + "/comment"}" method="POST" class="svelte-lc8ktd"><img src="${escape(DIR, true) + "/uploads/avatars/" + escape(avatar, true)}" alt="" class="svelte-lc8ktd">
		<input type="text" name="comment" placeholder="Send a comment..." autocomplete="off" spellcheck="false" class="svelte-lc8ktd"${add_attribute("value", input, 0)}${add_attribute("this", inputElement, 0)}>
		${``}</form>
</div>`;
});
const css$5 = {
...
const css$3 = {
  code: "a.svelte-17h5z09{display:grid;grid-template-columns:80px 1fr;grid-auto-rows:min-content;align-items:center;padding:10px;column-gap:10px;row-gap:5px}a.svelte-17h5z09:hover{background-color:#dddddd}img.svelte-17h5z09{grid-row:1 / span 3;width:80px;height:80px;object-fit:contain}h2.svelte-17h5z09{align-self:flex-start;font-size:20px;overflow:hidden;text-overflow:ellipsis}p.svelte-17h5z09{align-self:flex-start;text-overflow:ellipsis;font-weight:600}div.svelte-17h5z09{align-self:flex-end;justify-self:end;text-overflow:ellipsis;color:#555555}",
  map: null
};
const SideImage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a href="${"/gallery/" + escape(image.id, true)}"${add_attribute("title", image.title, 0)} class="svelte-17h5z09"><img src="${escape(DIR, true) + "/uploads/" + escape(image.filename, true)}"${add_attribute("alt", image.title, 0)} class="svelte-17h5z09">
  <h2 class="svelte-17h5z09">${escape(image.title)}</h2>
  <p class="svelte-17h5z09">${escape(image.author)}</p>
  <div class="svelte-17h5z09">${escape(image.views)} views ● ${escape(format(image.createdAt))}</div>
</a>`;
});
const css$2 = {
...
//# sourceMappingURL=_page.svelte-d420fb17.js.map
