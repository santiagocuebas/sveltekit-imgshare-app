  ...
  do {
    ...
    $$rendered = `${validate_component(ContainerForm, "ContainerForm").$$render($$result, { title: "Signin" }, {}, {
      default: () => {
		...
		<input type="text" name="username" placeholder="Username or Email" required class="svelte-jn909o">
		<input type="password" name="password" placeholder="Password" required class="svelte-jn909o">
...
//# sourceMappingURL=_page.svelte-8b9e5929.js.map
