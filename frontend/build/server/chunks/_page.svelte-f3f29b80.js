...
const ImageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-box svelte-159uz2p">${user?.username === image.author || user?.role !== UserRole.EDITOR ? `<div class="image-edit svelte-159uz2p"><i class="fa-solid fa-ellipsis svelte-159uz2p"></i>
...
//# sourceMappingURL=_page.svelte-f3f29b80.js.map
