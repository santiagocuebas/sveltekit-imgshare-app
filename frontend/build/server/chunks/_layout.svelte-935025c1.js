import { c as create_ssr_component, v as validate_component, e as escape, b as add_attribute } from './index2-deb300cf.js';
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="svelte-1d0j6v1"><a class="nav-logo svelte-1d0j6v1" href="/"><img class="nav-tiny-logo svelte-1d0j6v1" src="/tiny-logo.png" alt="">
	...
	${user ? `
		<img id="nav-avatar" class="nav-avatar svelte-1d0j6v1" src="${escape(DIR, true) + "/uploads/avatars/" + escape(user?.avatar, true)}"${add_attribute("alt", user?.username, 0)}>
...
//# sourceMappingURL=_layout.svelte-935025c1.js.map
