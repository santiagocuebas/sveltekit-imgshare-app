import { c as create_ssr_component, v as validate_component, f as each, e as escape, h as add_attribute, d as null_to_empty } from './index2-dd005ad7.js';
...
const UserChange = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="user-box-change svelte-1tedfbp"><div class="svelte-1tedfbp"><h6 class="svelte-1tedfbp">Change role:</h6>
    <select name="role" id="role" class="svelte-1tedfbp"><option value="editor" ${role === UserRole.EDITOR ? "selected" : ""} ${role === UserRole.ADMIN && myRole !== UserRole.SUPER ? "disabled" : ""} class="svelte-1tedfbp">EDITOR</option><option value="mod" ${role === UserRole.MOD ? "selected" : ""} ${role === UserRole.ADMIN && myRole !== UserRole.SUPER ? "disabled" : ""} class="svelte-1tedfbp">MOD</option><option value="admin" ${role === UserRole.ADMIN ? "selected" : ""} ${myRole !== UserRole.SUPER ? "disabled" : ""} class="svelte-1tedfbp">ADMIN</option></select></div>
...
//# sourceMappingURL=_page.svelte-af41568d.js.map
