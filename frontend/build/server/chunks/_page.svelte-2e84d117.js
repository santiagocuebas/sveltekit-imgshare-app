...
const css$a = {
  code: ".image-box.svelte-159uz2p.svelte-159uz2p{grid-column:1 / span 4;display:grid;grid-auto-rows:min-content;height:min-content;background-color:#ffffff;box-shadow:0 2px 10px #666666}.image-edit.svelte-159uz2p.svelte-159uz2p{display:flex;position:relative;justify-content:flex-end;align-items:center;height:30px;padding:0 10px;background-color:#444444}.image-edit.svelte-159uz2p i.svelte-159uz2p{display:flex;align-items:center;justify-content:center;width:24px;height:16px;margin-left:auto;padding:0;border:none;color:#ffffff;cursor:pointer}.image-edit.svelte-159uz2p i.svelte-159uz2p:hover{background-color:#666666}.image-author.svelte-159uz2p.svelte-159uz2p{display:grid;grid-template-columns:48px 1fr;grid-auto-rows:min-content;align-content:center;height:min-content;padding:6px;column-gap:10px}.image-author-link.svelte-159uz2p.svelte-159uz2p{grid-row:1 / span 2;width:48px;height:48px}.image-author.svelte-159uz2p img.svelte-159uz2p{width:100%;height:100%;border-radius:50%;box-shadow:0 0 1px 1px #666666;object-fit:cover}.image-author-username.svelte-159uz2p.svelte-159uz2p{width:max-content;height:min-content;font-size:20px;font-weight:700}.image-content.svelte-159uz2p.svelte-159uz2p{max-width:768px;height:auto;margin:0 auto}.image-description.svelte-159uz2p.svelte-159uz2p{padding:20px;overflow-wrap:anywhere;text-align:center}.image-description.svelte-159uz2p form.svelte-159uz2p{display:flex;flex-wrap:wrap;justify-content:center;gap:10px}.image-description.svelte-159uz2p textarea.svelte-159uz2p{width:100%;height:fit-content;padding:10px;border:none;outline:none;border-bottom:2px solid #666666;overflow-wrap:anywhere;text-align:center;scrollbar-width:none}.image-description.svelte-159uz2p button.svelte-159uz2p{width:100px;padding:8px 0;border:none;border-radius:6px;background-color:#d33535;font-weight:700;color:#ffffff;cursor:pointer}.image-description.svelte-159uz2p .blue.svelte-159uz2p{background-color:#4d4adb}@media(max-width: 1040px){.image-box.svelte-159uz2p.svelte-159uz2p{grid-column:1 / span 6}}",
  map: null
};
const ImageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="image-box svelte-159uz2p">${user && (user?.username === image.author || user?.role !== UserRole.EDITOR) ? `<div class="image-edit svelte-159uz2p"><i class="fa-solid fa-ellipsis svelte-159uz2p"></i>
			${slots.default ? slots.default({}) : ``}</div>` : ``}
	<h2 class="title"><i class="fa-solid fa-image title-icon"></i>
		${escape(image.title)}</h2>
	<div class="image-author svelte-159uz2p"><a class="image-author-link svelte-159uz2p" href="${"/user/" + escape(image.author, true)}"><img src="${escape(DIR, true) + "/uploads/avatars/" + escape(image.avatar, true)}"${add_attribute("alt", image.author, 0)} class="svelte-159uz2p"></a>
		<a class="image-author-username svelte-159uz2p" href="${"/user/" + escape(image.author, true)}">${escape(image.author)}</a>
		<p>${escape(image.views)} views ● ${escape(format(image.createdAt))}</p></div>
	<img class="image-content svelte-159uz2p" src="${escape(DIR, true) + "/uploads/" + escape(image.filename, true)}"${add_attribute("alt", image.title, 0)}>
	<div class="image-description svelte-159uz2p">${description ? `<form action="${escape(DIR, true) + "/api/image/" + escape(image.id, true) + "/description"}" method="POST" class="svelte-159uz2p"><textarea id="edit" name="description" rows="1" spellcheck="false" autocomplete="off" maxlength="4200" class="svelte-159uz2p">${image.description || ""}</textarea>
				<button class="svelte-159uz2p">Cancel
				</button>
				<button class="blue svelte-159uz2p">Send
...
//# sourceMappingURL=_page.svelte-2e84d117.js.map
